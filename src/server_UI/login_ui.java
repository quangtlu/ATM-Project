...
String ipAddress="192.168.253.8";
int portNumber=8008;
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            if(Clicent.Clicent==null){
            Clicent.connectToSever(ipAddress, portNumber);
            Clicent.getStreams();}
            Clicent.SendData(new LoginS(jTextField1.getText(),Security.encrypt(jPasswordField1.getText())));
            Object tem= Clicent.ReceiveData();
            if(tem instanceof LoginS){
                LoginS log=(LoginS)tem;
                if(log.getStatus()){
                    super.setVisible(false);
                    servers_UI.main(null);
                }else{
                    showMessage.showmessage(log.getMsg());
                }
            }
        } catch (IOException ex) {
            Logger.getLogger(servers_UI.class.getName()).log(Level.SEVERE, null, ex);
        }
